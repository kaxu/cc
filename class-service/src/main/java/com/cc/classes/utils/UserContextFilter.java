...
public class UserContextFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        logger.debug("Entering the UserContextFilter for the classinfo service");
        HttpServletRequest httpServletRequest = (HttpServletRequest) servletRequest;
        logger.debug("I am entering the classinfo service id with auth token: ", httpServletRequest.getHeader("Authorization"));
        ...
        logger.debug("***** I am entering the classinfo service id with correlation id: {}" ,correlationId);
